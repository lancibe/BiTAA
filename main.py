# CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --config_file acc_configs/gpu4.yaml main.py big --workspace workspace_debug_1202
import tyro
import time
import random
...
def main():    
    ...
    # data
    if opt.data_mode == 's3':
        from core.provider_objaverse_new import ObjaverseDataset as Dataset
    else:
    ...
    pct_start = min(3000 / total_steps, 1.0) # 由于数据集过小在这里修改
