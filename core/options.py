...
class Options:
    ...
    # dataset path
    data_root: str = './core/carla_dataset_v4.0'
    # fovy of the dataset Y轴视场角,单位度
    fovy: float = 90.0 # 58.7 # 49.1
    # camera near plane 近裁剪平面距离
    znear: float = 0.5 # 0.5
    # camera far plane
    zfar: float = 20.0 # 100.0 # 2.5
    ...
    # batch size (per-GPU)
    batch_size: int = 1 # 4 # 8
    # gradient accumulation
    gradient_accumulation_steps: int = 1
    # training epochs
    num_epochs: int = 30
    # lpips loss weight
    lambda_lpips: float = 0 # unused # 1.0
    # gradient clip
    ...
    prob_grid_distortion: float = 0.01 #0.5
    # augmentation prob for camera jitter
    prob_cam_jitter: float = 0.01 #0.5
