...
try:
    if XFORMERS_ENABLED:
        ...
        # warnings.warn("\033[93m[WARN] xFormers is available (Attention)\033[0m")
    # else:
    #     warnings.warn("\033[93m[WARN] xFormers is disabled (Attention)\033[0m")
    #     raise ImportError
except ImportError:
    XFORMERS_AVAILABLE = False
    warnings.warn("\033[93m[WARN] xFormers is not available (Attention)\033[0m")
